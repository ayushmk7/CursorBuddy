# Backend agents — guidance for Claude / Cursor
...
3. [`BACKEND_VS_LOCAL_RUNTIME.md`](BACKEND_VS_LOCAL_RUNTIME.md) — what “backend” means vs extension / sidecar / overlay.
4. [`COMPANION_OVERLAY_UX_SPEC.md`](COMPANION_OVERLAY_UX_SPEC.md) — pointer‑locked companion bubble, chord, streaming text.
5. [`HOST_COMPAT_VS_CURSOR.md`](HOST_COMPAT_VS_CURSOR.md) — VS Code vs Cursor host notes.
...
| [`docs/03_BACKEND_PRD.md`](../../docs/03_BACKEND_PRD.md) | Bridge, auth, session minting |
| [`docs/06_BACKEND_IMPLEMENTATION_STEPS.md`](../../docs/06_BACKEND_IMPLEMENTATION_STEPS.md) | Phased build order |
| [`docs/07_LOCAL_CURSOR_AND_COMPANION.md`](../../docs/07_LOCAL_CURSOR_AND_COMPANION.md) | Local UI, optional overlay |
